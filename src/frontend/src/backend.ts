...
import type { ExternalBlob as _ExternalBlob, UserRole as _UserRole, VideoEntry as _VideoEntry, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addVideoEntry(arg0: string, arg1: string, arg2: string | null, arg3: string | null, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addVideoEntry(arg0, arg1, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg3), await to_candid_ExternalBlob_n9(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_VideoEntry_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoEntry): Promise<VideoEntry> {
...
async function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_VideoEntry]): Promise<VideoEntry | null> {
    return value.length === 0 ? null : await from_candid_VideoEntry_n13(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        bibleReference: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.bibleReference)),
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_VideoEntry>): Promise<Array<VideoEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_VideoEntry_n13(_uploadFile, _downloadFile, x)));
}
